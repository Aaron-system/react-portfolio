...
export const contentGuides = {
  ...
  'Tell me about the tribe simulation': `The DVG Tribe Simulation is my agent-based economics research project — a ground-up Rust rebuild with evolving neural networks, graded chemistry, bilateral trade, credit, and emergent language. Click the simulation card on the homepage for the full presentation: tech stack, world maps, compounds, weapons, language signs, agent biographies, and research findings from the golden_10k_1 run.`,
};
